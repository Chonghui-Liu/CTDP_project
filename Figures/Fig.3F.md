...
```r
  ...
  scDist_result_list_sample3clusters <- lapply(PBMC_Travaglini_SC_sample3clusters_list, function(sc_data) {
  ...
  save(scDist_result_list_sample3clusters,file = "/data/chliu/Supervised_Phen_subpopulations_project/test/scDist_result_list_sample3clusters.rdata")
