...
```r
  ...
  da_cells_list_sample3clusters <- lapply(PBMC_Travaglini_SC_sample3clusters_list, function(sc_data) {
    da_cells <- getDAcells(
  ...
  save(da_cells_list_sample3clusters,file = "/data/chliu/Supervised_Phen_subpopulations_project/test/da_cells_list_sample3clusters.rdata")
...
```r
 load("/data/chliu/Supervised_Phen_subpopulations_project/test/PBMC_Travaglini_SC_sample3clusters_list.rdata")
  ...
  da_cells <- da_cells_list_sample3clusters[[i]]  
  ...
  cairo_pdf(paste0("/data/chliu/Supervised_Phen_subpopulations_project/figures of graduation/",names(PBMC_Travaglini_SC_sample3clusters_list)[i],"_DAseq_pred_UMAP.pdf"))
